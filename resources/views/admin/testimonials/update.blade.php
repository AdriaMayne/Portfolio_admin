        ...
        <form action="{{ action('TestimonialController@update', [$testimonial->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <label class="custom-file-label" for="image">{{ $testimonial->image}}</label>
                    </div>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-12 mt-2">
                    <div class="custom-control custom-checkbox">
                        @if ($testimonial->visible == 1)
                            <input type="checkbox" class="custom-control-input" id="visible" name="visible" value="{{ $testimonial->visible }}" checked>
                        @else
                            <input type="checkbox" class="custom-control-input" id="visible" name="visible" value="{{ $testimonial->visible }}">
                        @endif
